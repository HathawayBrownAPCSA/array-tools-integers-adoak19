/** The class IntegerArrayTools implements a variety of basic array tasks
  ...
  * 
  * Revised version of IntegerArrayTools
  * This program now states the correct index for the maximum and minimum values of an array
  * 
  * @Author Anna Doak January 24 2017
  */

import java.util.Scanner;

public class NewIntegerArrayTools
{
  ...
  /** Finds the highest value of an integer array
  ...
  /** Finds the smallest value of an integer array
