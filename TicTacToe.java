...
public class TicTacToe extends JPanel
{
  JButton buttons[][] = new JButton[3][3]; 
    ...
    // Thus, each button needs an ActionListener. 
    ...
    private class buttonListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            ...
            // If you try to take a spot that's already taken, you lose your turn
            if (buttonClicked.getText().length() > 0)
            {
              JOptionPane.showConfirmDialog(null, "This spot is already taken!", 
                          "You can only go in an empty space", JOptionPane.DEFAULT_OPTION);
              alternate++;
            }
